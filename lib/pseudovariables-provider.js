...
import suggestions from '../data/kamailio_5_1_x_pseudovariables';

class PseudovariablesProvider {
	constructor() {
	...
	inflateSuggestion(replacementPrefix, suggestion) {
		let inflatedSuggestion = {
			...
			iconHTML: '<i class="pseudovar-icon"></i>',
...
export default new PseudovariablesProvider();
